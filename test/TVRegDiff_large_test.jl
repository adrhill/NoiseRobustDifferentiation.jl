...
_testset_symbolic_functions("large", ["amg_rs","amg_sa","cholesky","diagonal","none"], ["abs","square"])
...
@testset "Broken inputs" begin
    ...
    @test_throws ArgumentError TVRegDiff([0, 1, 2], 1, 0.1, scale="large", diff_kernel="bad_input")
