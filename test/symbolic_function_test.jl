...
function _test_symbolic_functions(scale, precond, diff_kernel)
    @testset "abs" begin
        ...
        @test _eval_function(abs, sign, scale, precond, diff_kernel, n = 50, iter = 10) <
              0.26
        @test _eval_function(abs, sign, scale, precond, diff_kernel, n = 1000, iter = 2) <
              0.3
        @test _eval_function(abs, sign, scale, precond, diff_kernel, n = 1000, iter = 10) <
              0.14
    end
    @testset "sigmoid" begin
        ...
        @test _eval_function(σ, dσdx, scale, precond, diff_kernel; n = 1000, iter = 10) <
              0.17
    end
    @testset "sin" begin
